...
\end{equation}
In this function first component represents plateau function with break, which can have complex shape (sharp or wide), second two components describe QPO main harmonics in its overtone, fourth component represent any additional high frequency power, it can be connected either with detector dead time effects or can describe broad featureless component connected to the QPO power spreading to the high frequencies, last component represents constant Poisson noise component.
