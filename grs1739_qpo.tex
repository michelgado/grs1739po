...
%In the frame of the QPO relativistic precession model derived accretion disk inner radius requires massive black hole ($M_{\rm BH} > 30M_\odot$).
In the frame of the relativistic precession model, in order to satisfy both the observed QPO frequency and derived accretion disk truncation radius massive ($M_{\rm BH} > 30M_\odot$) black hole is required.
\end{abstract}
...
\citet{miller15_nust} shown that the average spectrum during the observation is well described by the relativistic reflection models such as \texttt{relxill} \citep{garcia14, dauser14,dauser16} with the accretion disk that reaches remarkably close to the black hole innermost stable circular orbit (ISCO). 
...
%We found that no additional soft components (describing, i.e. emission of the cold accretion disk) is required. 
%Also, estimated absorption was higher than that derived by \citet{fuerst16_gx339} in the quiescence state (see Table~\ref{tab:fullfit}). 
...
%than that derived for the quiescence state \citep
...
\subsection{Phase lags}
        ...
        The phase lag in different BHC system was being investigated by many authors \citep[see, e.g.][]{2003A&A...407..335M, 2006A&A...449..703R, 2011A&A...533A...8B, 2011MNRAS.415..292M, 2013MNRAS.435.2132M, 2017MNRAS.471.1475D}.
...
%First example of $\Delta \tau \propto f^{-0.7}$ behavior was found by  in Cyg X-1 and later investigated with the better resolution based on the RXTE observatory data by \citet{1999ApJ...517..355N}. 
...
\citet{2017ApJ...845..143Z} shown that the phase lag at the QPO frequency and its second harmonic in GX~339-4 BHC evolves with its frequency. 
...
Using \nustar\, data we found a prominent type-C LF QPO in its power spectrum, with monotonically growing frequency. As its frequency increases from 0.3 to 0.7 Hz spectrum became softer: the power law index grows from 1.46 to 1.53 and cut-off energy decreases from 30 to 26 keV. Taking the advantage of the presence of the broad Fe K$\alpha$ emission line, which is usually thought to originate due to the reflection from the cold accretion disk, following the analysis performed earlier by \citet{miller15_nust}, we used {\texttt relxill} spectral model in order to estimate the accretion disk inner radius. Although the quality of the data prevented us from measuring a movement of the inner disk boundary throught the observation, from the total broadband energy spectrum we found that the accretion disk is truncated at the radius smaller than 9 $GM/c^{2}$ (90\% confidence limit) which is in agreement with an estimates by \citet{miller15_nust}. 
