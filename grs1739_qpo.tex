...
\begin{figure*}
        \includegraphics[trim=0 0 0 0.45cm, clip, width=\columnwidth]{spectrum_model_and_cospectrum0.pdf}
        \includegraphics[width=\columnwidth, height = 0.77\columnwidth]{spectrum_model_and_cospectrum10.pdf}
...
Following \citep{2015MNRAS.446.3516I} we tried to extract QPO profile segregating the coherent part (Fourie signal with concerving phase shift relative to the signal on QPO frequency) between the QPO and it's harmonics, however no significant coherence was presented above the noise level.
It indicates that the QPO profile was not stable during the observation, in contradition to the result obtained by \citep{2015MNRAS.446.3516I} for GRS~1915+105 with {\it RXTE} observatory data.

Since the 2-nd harmonic is quite prominent in the power spectrum and therefore dominant over Poisson noise and broad-band noise we concluded that absence of Fourie signal with converved phase shift indicates on one can conclude that the QPO profile was not stable along the observation. 
...
\subsection{Phase lags}
        From the definition of the coherence it follows that coherent signals Fourier function on average have constant 
    
        In previous section we demonstrated that \grs\ hard and soft are coherent during {\it NuSTAR} observation. 
From the definition of the coherence it follows that there is a constant phase shift between coherentflux light-curves It was mentioned in previous section that coherence demonstrates linear 
