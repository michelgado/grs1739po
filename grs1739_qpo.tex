...
Another feature, frequently observed in the X-ray binaries power spectra is different types of low and high frequency QPOs, manifesting itself as a narrow Lorentzian components \citep[see][for LFQPO classification]{casella05}. 
One of the long-standing questions in X-ray timing is the origin of those low-frequency QPOs, which are often found in X-ray binaries harboring both neutron stars and black-holes \citep{wijnands99} during initial rise and transition to disk dominated state - i.e. in low-hard state (LHS) and in hard intermediate state (HIMS), according to standard scheme \citep{grebenev97, tanaka96, remillard06, belloni10}. 
...
The coherence between hard and soft energy bands at frequencies up to $s\im3$~Hz is presented in Fig.~\ref{fig:coherence}. 
